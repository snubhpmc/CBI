...
<div class="row" style="margin-bottom: 3rem;">
  ...
  <div class="col-sm-9" style="display: flex; flex-direction: column;">
    ...
    {% endif %}
    {% if member.homepage %}
    <a href="{{ member.homepage }}" target="_blank" title="Go to university homepage"><i class="fas fa-university"></i> SNU-HST</a>
    {% endif %}
...
<div class="row">
{% assign students = site.team | where: "role", "PhD Student" | sort: "order" %}
{% for student in students %}
  <div class="col-sm-6 col-md-3" style="margin-bottom: 2rem;">
    <div style="display: flex; flex-direction: column; height: 100%;">
      {% if student.photo %}
      <img src="{{ '/assets/img/team/' | append: student.photo | relative_url }}" class="img-fluid rounded-circle" alt="{{ student.name }}">
      {% endif %}
      ...
      {% if student.email %}
      <a href="#" onclick="navigator.clipboard.writeText('{{ student.email }}'); alert('Email copied to clipboard!'); return false;" title="Click to copy email address"><i class="fas fa-envelope"></i> Email</a>
      {% endif %}
      {% if student.google_scholar %}
      <a href="{{ student.google_scholar }}" target="_blank" title="Go to Google Scholar profile"><i class="ai ai-google-scholar"></i> Google Scholar</a>
      {% endif %}
      </p>
    </div>
  </div>
...
<div class="row">
{% assign alumni = site.team | where: "role", "Alumni" | sort: "order" %}
