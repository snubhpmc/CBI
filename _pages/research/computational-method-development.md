...
permalink: /research/computational-method-development/
description: "Applying machine learning and deep learning techniques to clinical data for disease prediction, diagnosis, and treatment optimization."
nav: false
---
...
{% assign category = site.data.research | where: "category", "Computational Method Development" | first %}
